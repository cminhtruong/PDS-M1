package metier.client.presentation.connection;
 ...
 * @since JVM 1.7
 * @since 2015/02/14
 * @see <br>Http Connect between Presentation Client and Web App
 */
...
public class HttpConnection implements Serializable {
	...
	/**
	 * @see HttpConnection 
	 * 		Create a connection between clientPresentation's
	...
	/**
	 * <br> Initialize a connection between client and the first web application
	 * @param urlWebApp
	 * @param message
	 * @throws MalformedURLException
	 */
	public void initConnection(String urlWebApp, Object message) throws MalformedURLException{
		LOG.info("Create a connection to the first web app ...");
		url 	= 	new URL(urlWebApp);
		object 	= 	message;
	}
	
	/**
	 * <br> Send the message received from presentation to the first web application
	 * @param method
	 */
